...
import com.mycompany.enviarmensagenswpp.EnviarMensagensWPP;
...
EnviarMensagensWPP enviar;
    /**
     * Creates new form TelaMensagem
     */
    public TelaMensagem() {
        initComponents();
        enviar = new EnviarMensagensWPP();
    }
    ...
    private void initComponents() {
        ...
        destino.setText("Número");

        mensagem.setColumns(20);
        mensagem.setRows(5);
        jScrollPane1.setViewportView(mensagem);

        jButton1.setText("Enviar Mensagem via Twilio");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        enviar.enviArMensagemViaTwilio(destino.getText(), mensagem.getText());
